...
def print_marriages(marriages_dict, people_dict):
    ...
    for marriage_key, marriage_data in marriages_dict.items():
        husband_key = marriage_data[0]
        husband_data = people_dict[husband_key]
        husband_name = husband_data[0]
        husband_birth_year = husband_data[2]
        marriage_year = marriage_data[2]

        wife_key = marriage_data[1]
        wife_data = people_dict[wife_key]
        wife_name = wife_data[0]
        wife_birth_year = wife_data[2]

        husband_age_at_marriage = marriage_year - husband_birth_year

        wife_age_at_marriage = marriage_year - wife_birth_year
