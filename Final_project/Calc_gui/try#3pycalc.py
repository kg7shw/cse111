...
label = Label(window, textvariable=equation_label, font=('consolas',20), bg="black", fg='red', width=24, height=2)
label.pack()
...
equal = Button(frame, text='=', height=4, width=19, font=35, bg=ORANGE,
                 command=equals)
